...
import {updateItemQuantity, deleteCartItem} from "../../../Redux/Cart/CartSlice";
              ...
              return (
                <div>
                  <div className="row cart-item-card">
                    <div className="col-4">
                      <img
                        src={require("../../../Assets/" + item.product_img)}
                      ></img>
                    </div>
                    <div className="col-8">
          ...
          <div className="col-4 px-4 py-3 my-4 cart-summary">
            ...
            <div>
              ...
              <span className="summary-total">
                {" "}
                Total: ${" "}
                {isNaN(cart.totalItemsPrice) ? 0 : cart.totalItemsPrice}
              </span>
              <hr />
            </div>
